...
class Note extends Entity
{
    ...
    // TODO: Проверить, допустимы ли до сих пор значения 5, 6, 7, 8
    const ATTACHMENT              = 5;   // Файл
    ...
    const SYSTEM                  = 25; // Системное сообщение
    ...
    const TYPE_TASK    = 4; // Привязка к задаче. Для задачи доступен только тип события TASK_RESULT
    const TYPE_BUYER   = 5; // Привязка к покупателю
